...
export function CtaBanner({
  ...
  return (
    <section className="page-shell py-8" aria-labelledby={titleId}>
      <div className="overflow-hidden rounded-xl bg-[linear-gradient(112deg,var(--brand-blue)_0%,#0b45bd_45%,#3373e6_100%)] shadow-[0_22px_48px_rgb(0_14_53/0.16)]">
